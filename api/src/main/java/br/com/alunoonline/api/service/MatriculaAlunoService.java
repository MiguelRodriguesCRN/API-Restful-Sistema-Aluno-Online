...
public class MatriculaAlunoService {
                ...
                matriculaAlunoRepository.findById(matriculaAlunoId)
                        .orElseThrow(() ->
                            new ResponseStatusException(HttpStatus.NOT_FOUND,
                                    "Matricula Aluno não encontrada | Tente Novamente!"));
    ...
    public HistoricoAlunoResponse emitirHistorico(Long alunoId) {
        ...
        if (matriculasDoAluno.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Aluno informado Não possui Matrciuslas");
        }
        ...
        for (MatriculaAluno matriculaAluno : matriculasDoAluno) {
            ...
            disciplinasAlunoResponse.setNomeDiscplina(matriculaAluno.getDisciplina().getNome());
